...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Package Squirrels Observations",
    Description = "Improve data analisis of Squirrels observations datasets",
    `Authors@R` = c(
      person("Bruno", "Carayon", email = "carayon@unhcr.org", role = c("aut", "cre")),
      person(given = "ThinkR", role = "cph")
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Bruno Carayon")
```
...
```{r}
# Create dataset in data raw (accesible to end user)
...
usethis::use_git_remote("origin",
                        url = "https://github.com/training-unhcr-n2/squirrelsbruno.git",
                        overwrite = TRUE)
